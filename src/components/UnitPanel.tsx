  ...
  return (
    <div className="h-full flex flex-col bg-black/80">
      <div className="p-2 space-y-2">
        ...
        <div className="flex items-center p-1.5 bg-black/60 rounded">
        ...
        <div className="flex justify-between items-center text-xs text-gray-400">
          <div className="flex items-center space-x-2">
            <span>Group by</span>
            <button className="bg-black/60 rounded px-2 py-1 flex items-center">
              <span>Echelon</span>
              <ChevronDown size={14} className="ml-1" />
            </button>
          </div>
          <button className="bg-black/60 rounded px-2 py-1">
            Orbit
          </button>
        </div>
      </div>
