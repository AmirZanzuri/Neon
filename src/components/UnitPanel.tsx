  ...
  return (
    <div className="h-full flex flex-col bg-black/40">
      <div className="flex-none p-2 space-y-2">
        ...
        <div className="flex items-center p-1.5 bg-black/40 rounded">
        ...
        <div className="flex justify-between items-center text-xs text-gray-400">
          <div className="flex items-center space-x-2">
            <span>Group by</span>
            <button className="bg-black/40 rounded px-2 py-1 flex items-center">
              <span>Echelon</span>
              <ChevronDown size={14} className="ml-1" />
            </button>
          </div>
          <button className="bg-black/40 rounded px-2 py-1">
            Orbit
          </button>
        </div>
      </div>
      
      <div className="flex-1 overflow-y-auto min-h-0 scrollbar-none bg-black/40">
        {echelons.map(echelon => (
          <div key={`echelon-${echelon}`} className="border-b border-white/5">
            <button 
              className="w-full flex items-center p-2 hover:bg-black/50 text-gray-300"
