...
const UnitPanel: React.FC<UnitPanelProps> = ({ units, onSelectUnit, selectedUnit, onClose }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-black/20">
      ...
      <div className="flex-1 overflow-y-auto min-h-0 bg-black/20 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-600/50 [&::-webkit-scrollbar-thumb]:rounded-full">
