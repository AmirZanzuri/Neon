      ...
      <div className="bg-black/40 rounded-t-md px-2 py-1 flex items-center space-x-4">
        {buttons.map((button, index) => (
          <React.Fragment key={button.id}>
            <button
              className="p-1.5 rounded-sm hover:bg-black/30 text-gray-300 hover:text-white transition-colors"
        ...
        <button className="p-1.5 rounded-sm hover:bg-black/30 text-gray-300 hover:text-white transition-colors">
